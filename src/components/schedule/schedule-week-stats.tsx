...
export const ScheduleWeekStats = ({ lessons }: ScheduleWeekStatsProps) => {
  ...
  return (
    <aside className="flex flex-col gap-4 rounded-lg border border-border/70 bg-white/30 p-4 sm:p-5">
      <div>
      ...
      <div className="flex gap-2.5 rounded-lg border border-white/50 bg-primary/5 px-3 py-2.5">
        <Lightbulb
